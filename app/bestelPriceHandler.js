...
function calculateSum(){// met deze functie gaan we berekenen wat de totaalprijs is van de gekozen componenten
    for (var i=0;i<intPriceArray.length;i++){// een kleine for loop die door de array heen gaat loopen
        Sum+=parseInt(intPriceArray[i]);// bij elke loop wordt het waarde van de huidige array[index] toegevoegd aan onze Sum variable
    }
